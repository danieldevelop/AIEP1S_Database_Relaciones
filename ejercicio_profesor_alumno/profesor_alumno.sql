-- Active: 1680928443591@@127.0.0.1@3306@profesor_alumno
/**
 ...
 *
 * DATABASE profesor_alumno
 * PREFIX DATABASE ap
 */

CREATE DATABASE IF NOT EXISTS profesor_alumno;
-- USE profesor_alumno;
...
ALTER TABLE ap_modulo_has_alumno
    ...
    ADD CONSTRAINT FK2_ALUMNO_numero_expediente FOREIGN KEY(ALUM_numero_expediente) REFERENCES ap_alumno(numero_expediente);
